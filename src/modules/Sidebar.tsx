...
export default function Sidebar() {
    const { lineActive, setLineActive, sidebarExpanded, toggleSidebar, setSidebarRef } = useUtilsStore((state) => state);
    ...
    return (
        <aside
            ref={sidebarRef}
            onMouseEnter={() => {
                if (lineActive) setLineActive(false);
            }}
            ...
            style={!sidebarExpanded ? { left: "-250px" } : {}}
        >
            <ExpandComponent />
